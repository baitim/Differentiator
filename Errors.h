...
const Error ERRORS[] = {
    ...
    {ERROR_INVALID_TREE,        "invalid pointer to equation"},
    {ERROR_SYSTEM_COMMAND,      "cannot process system command"},
    {ERROR_OPEN_FILE,           "invalid name of file"},
    {ERROR_EMPTY_NODE,          "invalid node in equation"},
    ...
    {ERROR_TREE_LOOP,           "equation has loop"},
    {ERROR_TREE_DEP,            "wrong depth in equation"},
